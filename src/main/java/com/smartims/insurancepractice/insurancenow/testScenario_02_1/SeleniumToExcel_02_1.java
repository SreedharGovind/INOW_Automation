...
public class SeleniumToExcel_02_1 {
    ...
    WebElement premiumValue(ChromeDriver driver, String transaction) {
        ...
        if (transaction == "NewBusinessPolicyNumber_TS02") {
            return driver.findElement(By.id("PolicySummary_PolicyNumber"));
        }
        if (transaction == "NewBusiness Premium_TS02") {
            return driver.findElement(By.id("PolicySummary_PremWithTaxesFeesAmt"));
        }
        if (transaction == "Endorsement Premium_TS02") {
            return driver.findElement(By.id("PolicySummary_PremWithTaxesFeesAmt"));
        }
        if (transaction == "Cancellation Premium_TS02") {
            return driver.findElement(By.id("PolicySummary_PremWithTaxesFeesAmt"));
        }
        if (transaction == "Reinstatement Premium_TS02") {
            return driver.findElement(By.id("PolicySummary_PremWithTaxesFeesAmt"));
        }
        if (transaction == "RewriteNew Premium_TS02") {
            return driver.findElement(By.id("PolicySummary_PremWithTaxesFeesAmt"));
        }
        if (transaction == "RenewalStart Premium_TS02") {
            return driver.findElement(By.id("PolicySummary_PremWithTaxesFeesAmt"));
        }
        return null;
    }
